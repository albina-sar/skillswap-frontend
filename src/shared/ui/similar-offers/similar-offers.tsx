...
//       <Heading level={2}  className={styles.heading}>Похожие предложения</Heading>
//         {users.map((userId) => (
//           <UserCardElement key={userId} authorid={userId}/>
//         ))}
//     </section>
//   </>
//   )
      ...
      <div className={styles.sliderWrapper}>
        ...
        >
          <svg width="5" height="10" viewBox="0 0 8 14" fill="none" xmlns="http://w3.org">
             <path d="M7 13L1 7L7 1" stroke="#69735D" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
           </svg>
        </button>
        ...
        >
          <svg width="5" height="10" viewBox="0 0 8 14" fill="none" xmlns="http://w3.org">
             <path d="M1 13L7 7L1 1" stroke="#69735D" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
           </svg>
        </button>
      </div>)}
      </>
